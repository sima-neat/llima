...
public:
  ...
  TranscriptionResult run_model(const std::filesystem::path& audio_file_name,
                                const std::string& language,
                                const std::string& task = "transcribe");
  TranscriptionResult run_model_from_pcm(std::span<const float> pcm, uint32_t sample_rate,
                                         const std::string& language,
                                         const std::string& task = "transcribe");
...
private:
  ...
  void _define_model(const std::string& model_type,
