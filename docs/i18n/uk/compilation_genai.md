...
| `--input_height` | Висота вхідного зображення в пікселях. Має бути вказана разом із `--input_width`. Обов’язково для моделей Qwen 2 VL, Qwen 3 VL, Qwen3.5 та Gemma 4; необов’язково для зміни встановленого розміру моделі SigLIP2. |
| `--input_width` | Ширина вхідного зображення в пікселях. Має бути вказана разом із `--input_height`. Обов’язково для моделей Qwen 2 VL, Qwen 3 VL, Qwen3.5 та Gemma 4; необов’язково для зміни встановленого розміру моделі SigLIP2. |
