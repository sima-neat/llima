...
_ONNX_REGRESSION_CONFIGS = [
    ("models--meta-llama--Llama-3.2-3B-Instruct",   "pre",    None),
    ("models--meta-llama--Llama-3.2-3B-Instruct",   "cache",  None),
    ("models--meta-llama--Llama-3.2-3B-Instruct",   "post",   None),
    ("models--google--gemma-3-4b-it",               "pre",    None),
    ("models--google--gemma-3-4b-it",               "cache",  None),
    ("models--google--gemma-3-4b-it",               "post",   None),
    ...
    ("models--Qwen--Qwen2.5-3B-Instruct",           "pre",    None),
    ("models--Qwen--Qwen2.5-3B-Instruct",           "cache",  None),
    ("models--Qwen--Qwen2.5-3B-Instruct",           "post",   None),
    ("models--Qwen--Qwen3-4B",                      "pre",    None),
    ("models--Qwen--Qwen3-4B",                      "cache",  None),
    ("models--Qwen--Qwen3-4B",                      "post",   None),
