...
_GGUF_CONFIGS = [
    ...
    ("models--unsloth--Llama-3.2-1B-Instruct-GGUF",              "llama3.2_vlm_config.json"),
    # Gemma
    ("models--unsloth--gemma-4-E2B-it-GGUF",                     "gemma4_e2b_it_vlm_config.json"),
    # Mistral
    ...
    #Qwen
    ("models--Qwen--Qwen2.5-0.5B-Instruct-GGUF",             "qwen2.5_vlm_config.json"),
    ("models--Qwen--Qwen3-0.6B-GGUF",                        "qwen3_vlm_config.json"),
    # LiquidAI
    ("models--LiquidAI--LFM2-350M-GGUF",                         "lfm2_vlm_config.json"),
]
